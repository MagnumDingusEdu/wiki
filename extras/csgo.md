...
description: 
published: true
date: 2021-06-30T02:25:55.337Z
tags: 
editor: markdown
dateCreated: 2021-06-30T02:25:55.337Z
---

# Launch Options
```cpp
-novid -freq 240 -tickrate 128  +exec config.cfg +exec autoexec.cfg 
```

# <kbd>autoexec.cfg</kbd>
```cpp
// Crosshair
cl_crosshairstyle 4;
cl_crosshaircolor 2;
...
cl_crosshaircolor_g 213; cl_crosshaircolor_r 126;
...
cl_cmdrate "128" 
cl_updaterate "128"
cl_color "1" // set preferred color
cl_forcepreload "0" // preload shaders
cl_use_opens_buy_menu "0" // don't open buy menu
gameinstructor_enable "0" 
joystick "0" // disable joystick
mm_dedicated_search_maxping "150"
net_graph "1" // show fps
...
cl_crosshairdot "0"
cl_crosshairgap "-1.100000"
cl_crosshairgap_useweaponvalue "0"
cl_crosshairsize "2.400000"
cl_crosshairstyle "4"
...
// player controls
bind "z" "toggle cl_righthand 0 1" // switch directions
bind "MOUSE3" "player_ping" // ping a site

// voice and chat
bind "y" "+voicerecord" // speak
bind "SEMICOLON" "radio" // radio message
bind "f" "messagemode" // public chat
bind "g" "messagemode2" // team chat
...
snd_tensecondwarning_volume "0.077886" 
...
cachedvalue_count_partybrowser "1624308244"
cachedvalue_count_teammates "1624390664"
cam_collision "1"
cam_idealdelta "4.0"
cam_idealdist "150"
...
player_competitive_maplist_2v2_9_0_24235B08 "mg_de_train,mg_de_lake,mg_de_inferno,mg_de_shortnuke,mg_de_vertigo,mg_de_calavera,mg_de_pitstop,mg_de_shortdust,mg_de_overpass,mg_de_cbble"
player_competitive_maplist_8_9_0_FC5D166E "mg_de_mirage,mg_de_inferno,mg_de_mocha"
...
player_wargames_list2_9_0_E04 "mg_skirmish_flyingscoutsman,mg_skirmish_armsrace,mg_skirmish_demolition,mg_skirmish_retakes"
...
ui_vanitysetting_loadoutslot_ct "heavy2"
